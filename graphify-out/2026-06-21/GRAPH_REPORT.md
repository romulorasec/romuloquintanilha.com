# Graph Report - romuloquint  (2026-06-21)

## Corpus Check
- 73 files · ~346,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 573 nodes · 760 edges · 53 communities (34 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc9e4837`
...
8. `MotionFade()` - 9 edges
9. `Practical examples` - 9 edges
10. `Framer Motion Animation` - 9 edges
...
Cohesion: 0.06
Nodes (30): Conversion Copywriting Principles, Above the Fold, Core Sections, CTA Copy Guidelines, Page Structure Framework, AI Writing Tells (Transitions to Avoid), Natural Transitions Reference, Additional Formulas (+22 more)

### Community 3 - "Copywriting & Content Strategy"
Cohesion: 0.06
Nodes (33): 1. Page Purpose, 2. Audience, 3. Product/Offer, 4. Context, About Page, Alternatives, Annotations, Be Direct (+25 more)
...
Cohesion: 0.13
Nodes (24): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+16 more)
...
Cohesion: 0.09
Nodes (22): dependencies, class-variance-authority, clsx, framer-motion, gsap, @gsap/react, @hookform/resolvers, lenis (+14 more)
...
Cohesion: 0.06
Nodes (30): MotionFade(), MotionFadeProps, siteConfig, Navbar(), navLinks, About(), bodyStyle, ease (+22 more)
...
- **Why does `cn()` connect `UI Utility & Breadcrumb` to `Dependencies & Package Config`, `Next.js Framework`, `Dialog System`, `Site Config & Footer`, `Popover System`, `Avatar System`, `Alert Component`, `Tabs System`, `Community 18`, `GSAP Animation Engine`, `Brand Logo (Red Variant)`, `Brand Logo (Black Variant)`, `Graphify Agent Workflows`, `Site Config Types`, `Scroll Area System`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `Framer Motion Animation` connect `shadcn/ui Configuration` to `Dropdown Menu System`, `Root Layout & Fonts`, `Popover System`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Dropdown Menu System` to `Community 17`?**
...
- **Should `Copywriting & Content Strategy` be split into smaller, more focused modules?**
